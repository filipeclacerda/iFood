...
<html lang="pt-br">
    ...
    <body>
        <style>
            body {
                background-image: url('backw.jpg');
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="produto">Cupom Desconto</label><br>
                        ...
                        <center>
                            <button onclick="adicionarCupom()" type="button" class="btn btn-success">Adicionar Desconto</button>
                        </center>
                    </div>     
                </div>
            </div>
